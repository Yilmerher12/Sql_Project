-- ============================================
-- DML: Datos iniciales de la base de datos
...
('SNA-002', 'Hino',          10.5, 'active'),
('SNA-003', 'Freightliner',  15.0, 'active'),
('SNA-004', 'Freightliner',  15.0, 'maintenance'),
('SNA-005', 'International', 12.0, 'active'),
('SNA-006', 'International', 12.0, 'active'),
('SNA-007', 'Kenworth',      18.0, 'active'),
('SNA-008', 'Kenworth',      18.0, 'active'),
('SNA-009', 'Mercedes-Benz', 11.0, 'active'),
('SNA-010', 'Mercedes-Benz', 11.0, 'inactive'),
('SNA-011', 'Scania',        14.5, 'active'),
('SNA-012', 'Scania',        14.5, 'active'),
('SNA-013', 'Hino',          10.5, 'active'),
('SNA-014', 'Freightliner',  15.0, 'active'),
('SNA-015', 'International', 12.0, 'maintenance'),
('SNA-016', 'Kenworth',      18.0, 'active'),
('SNA-017', 'Mercedes-Benz', 11.0, 'active'),
('SNA-018', 'Scania',        14.5, 'active'),
('SNA-019', 'Hino',          10.5, 'active'),
('SNA-020', 'Freightliner',  15.0, 'active'),
('SNA-021', 'International', 12.0, 'active'),
('SNA-022', 'Kenworth',      18.0, 'active'),
('SNA-023', 'Mercedes-Benz', 11.0, 'maintenance'),
('SNA-024', 'Scania',        14.5, 'active'),
('SNA-025', 'Hino',          10.5, 'active'),
('SNA-026', 'Freightliner',  15.0, 'active'),
('SNA-027', 'International', 12.0, 'active'),
('SNA-028', 'Kenworth',      18.0, 'inactive'),
('SNA-029', 'Mercedes-Benz', 11.0, 'active'),
('SNA-030', 'Scania',        14.5, 'active'),
('SNA-031', 'Hino',          10.5, 'active'),
('SNA-032', 'Freightliner',  15.0, 'active'),
('SNA-033', 'International', 12.0, 'active'),
('SNA-034', 'Kenworth',      18.0, 'active'),
('SNA-035', 'Mercedes-Benz', 11.0, 'maintenance'),
('SNA-036', 'Scania',        14.5, 'active'),
('SNA-037', 'Hino',          10.5, 'active'),
('SNA-038', 'Freightliner',  15.0, 'active'),
('SNA-039', 'International', 12.0, 'active'),
('SNA-040', 'Kenworth',      18.0, 'active'),
('SNA-041', 'Mercedes-Benz', 11.0, 'active'),
('SNA-042', 'Scania',        14.5, 'active'),
('SNA-043', 'Hino',          10.5, 'active'),
('SNA-044', 'Freightliner',  15.0, 'active'),
...
('Chapinero Alto',      'Chapinero',       450),
('Rosales',             'Chapinero',       300),
('Chico Norte',         'Chapinero',       600),
('Cedritos',            'Usaquén',        1200),
('Santa Ana',           'Usaquén',         250),
('San Cristóbal Norte', 'Usaquén',         800),
('Modelia',             'Fontibón',        950),
('Hayuelos',            'Fontibón',       1100),
('Ciudad Salitre',      'Fontibón',       1500),
('Kennedy Central',     'Kennedy',        2000),
('Castilla',            'Kennedy',        1800),
('Patio Bonito',        'Kennedy',        2500),
('Suba Centro',         'Suba',           2200),
('La Colina',           'Suba',           1300),
('Lombardía',           'Suba',            900),
('Teusaquillo Centro',  'Teusaquillo',     500),
('Galerías',            'Teusaquillo',     700),
('La Soledad',          'Teusaquillo',     400),
('Engativá Pueblo',     'Engativá',       1400),
('Villas de Granada',   'Engativá',       1600),
('Garces Navas',        'Engativá',       1900),
('Bosa Centro',         'Bosa',           2100),
('El Recreo',           'Bosa',           2300),
('Metrovivienda',       'Bosa',           1700),
('Venecia',             'Tunjuelito',      850),
('San Vicente',         'Tunjuelito',      600),
('Restrepo',            'Antonio Nariño',  900),
('La Fragua',           'Antonio Nariño',  450),
('Paloquemao',          'Los Mártires',    300),
('Santa Isabel',        'Los Mártires',    750),
('Quinta Paredes',      'Teusaquillo',     550),
('Niza',                'Suba',           1000),
('Pasadena',            'Suba',            850),
('Mazuren',             'Suba',           1150),
('Lisboa',              'Usaquén',         700),
('Toberín',             'Usaquén',         950),
('El Tunal',            'Tunjuelito',     1800),
('Candelaria La Nueva', 'Ciudad Bolívar', 2400),
('El Perdomo',          'Ciudad Bolívar', 2100),
('Arborizadora Alta',   'Ciudad Bolívar', 2600),
('San Felipe',          'Barrios Unidos',  500),
('Siete de Agosto',     'Barrios Unidos',  650),
('Metrópolis',          'Barrios Unidos',  800),
('Las Nieves',          'Santa Fe',        350),
...
-- 4. Tabla: route_neighborhoods (Relación N:M rutas-barrios)
INSERT INTO route_neighborhoods (route_id, neighborhood_id) VALUES
(1, 4),  (1, 5),  (2, 6),  (2, 35), (3, 38), (3, 39),
(4, 7),  (4, 8),  (5, 9),  (5, 43), (6, 10), (6, 11),
(7, 13), (7, 14), (8, 1),  (8, 2),  (9, 16), (9, 18),
(10, 19),(10, 20),(11, 22),(11, 23),(12, 38),(12, 40),
(13, 41),(13, 42),(14, 44),(14, 45),(15, 29),(15, 30),
(16, 35),(16, 36),(17, 4), (17, 36),(18, 7), (18, 9),
(19, 25),(19, 37),(20, 27),(20, 28),(21, 29),(21, 30),
(22, 32),(22, 33),(23, 7), (23, 9), (24, 25),(24, 37),
(25, 17),(25, 31);

-- 5. Tabla: collections (Recolecciones)
